...
# !!! Main.UserApp is configured as an alias for Main.synthlab and you might encounter it in some tests
using Main.synthlab, Test, TestSetExtensions, Logging

Logging.global_logger(NullLogger())

@testset ExtendedTestSet "synthlab tests" begin
  @includetests ARGS
end
